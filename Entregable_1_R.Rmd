...
-   **Sigma².** La varianza residual mide la dispersión de los errores del modelo.
...
-   **Prueba Ljung-Box :**
    ...
    -   **¿Qué es?** Evalúa si hay autocorrelación significativa en los residuos hasta un número específico de retrasos.
