...
ggplot(merged_data, aes(x = NASDAQ, y = predicted_nasdaq)) +
  ...
  labs(title = "Valores Reales vs. Predichos (NASDAQ)",
       x = "Valores Reales (NASDAQ)",
       y = "Valores Predichos (NASDAQ)") +
  theme_minimal()
...
```{r}
merged_data$residuals <- residuals(modelo_nasdaq)

ggplot(merged_data, aes(x = predicted_nasdaq, y = residuals)) +
  geom_point(alpha = 0.6, color = "purple") +
  geom_hline(yintercept = 0, color = "red", linetype = "dashed") +
  labs(title = "Residuos vs Predicciones",
       x = "Valores Predichos (NASDAQ)",
       y = "Residuos") +
  theme_minimal()
